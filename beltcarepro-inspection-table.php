	...
	<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
		...
		<div class="main-content">
			...
			<div class="page-title">
				...
				<div class="title-env">
					<h1 class="title">Inspection Table</h1>
					...
					<div class="breadcrumb-env">
							...
							<li class="active">
										...
										<strong>Inspection Table</strong>
								</li>
								</ol>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Inspection Table</h3>
				...
				<div id="gallery"class="panel-body">
					...
					<table class="table table-striped table-bordered zoom" cellspacing="0" width="100%">
						...
						<tbody>
							<tr>
								<td>51ABC2</td>
								<td>SPC-51ABC2-001	</td>
								<td>Terkelupas/terbuka/robek dibagian saddle/overlap sambungan/edge belt</td>
								<td></td>
								<td></td>
								<td>2014-09-29 00:00:00</td>
								<td><img src="./assets/images/user-4.png" width="80" height="80"></br>Ex - repair pada Top joint ( Joint 1 ) pada bagian tengah dan kiri sudah terkelupas.</td>
								<td></td>
							</tr>
							<tr>
								<td>51ABC2</td>
								<td>SPC-51ABC2-002	</td>
								<td>Terkelupas/terbuka/robek dibagian saddle/overlap sambungan/edge belt</td>
								<td></td>
								<td></td>
								<td>2014-09-29 00:00:00</td>
								<td><a href="_blank"><img src="./assets/images/user-4.png" width="80" height="80"></br>Ex - repair pada Top joint ( Joint 1 ) pada bagian tengah dan kiri sudah terkelupas.</a></td>
								<td></td>
							</tr>
							<tr>
								<td>51ABC2</td>
								<td>SPC-51ABC2-003	</td>
								<td>Terkelupas/terbuka/robek dibagian saddle/overlap sambungan/edge belt</td>
								<td></td>
								<td></td>
								<td>2014-10-01 00:00:00</td>
								<td><a href="_blank"><img src="./assets/images/user-5.png" width="80" height="80"></br>Ex - repair pada Top joint ( Joint 1 ) pada bagian tengah dan kiri sudah terkelupas.</a></td>
								<td></td>
							</tr>
